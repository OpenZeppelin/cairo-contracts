...
For more information on how interface ids are calculated, see the xref:introspection.md#interface-calculations[ERC165 documentation].
...
See xref:account.md#mocksigner-utility[MockSigner utility] for more information.
