...
`openzeppelin_merkle_tree = "4.0.0-alpha.0"`
====
...
[.contract]
[[merkle_proof]]
=== `++merkle_proof++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v4.0.0-alpha.0/packages/merkle_tree/src/merkle_proof.cairo[{github-icon},role=heading-link]
...
[.contract]
[[hashes]]
=== `++hashes++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v4.0.0-alpha.0/packages/merkle_tree/src/hashes.cairo[{github-icon},role=heading-link]
