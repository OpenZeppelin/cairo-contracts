...
[.contract-index#ERC721ReceiverComponent-Embeddable-Impls-camelCase]
...
==== `[.contract-item-name]#++onERC721Received++#++(operator: ContractAddress, from: ContractAddress, token_id: u256, data Span<felt252>) -> felt252++` [.item-kind]#external#
