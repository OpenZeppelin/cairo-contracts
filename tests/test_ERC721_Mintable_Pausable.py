...
from utils import Signer, str_to_felt, TRUE, FALSE, assert_revert, to_uint

signer = Signer(123456789987654321)

account_path = 'contracts/Account.cairo'
erc721_path = 'contracts/token/ERC721_Mintable_Pausable.cairo'
...
async def test_pause(erc721_minted):
    ...
    await assert_revert(signer.send_transaction(
        ...
        reverted_with='Pausable_base: contract is paused'
    )
