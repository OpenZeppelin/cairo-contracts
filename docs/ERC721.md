...
- `ERC721Mintable_Burnable` includes `mint` and `burn`
- `ERC721Mintable_Pausable` includes `mint`, `pause`, and `unpause`
- `ERC721Enumerable_Mintable_Burnable` includes `mint`, `burn`, and [IERC721Enumerable](#ierc721enumerable) methods
