...
==== `[.contract-item-name]#++universal_deployer++#` [.item-kind]#module#

See xref:#universal_deployer[`openzeppelin::utils::universal_deployer`].
...
:deploy_syscall: link:thing.com[deploy_syscall]
...
--
.Functions
* xref:universal_deployer-calculate_contract_address_from_deploy_syscall[`++calculate_contract_address_from_deploy_syscall(salt, class_hash, constructor_calldata, deployer_address)++`]
* xref:universal_deployer-compute_hash_on_elements[`++compute_hash_on_elements(data)++`]
* xref:universal_deployer-udc_calculate_contract_address_from_zero[`++udc_calculate_contract_address_from_zero(salt, class_hash, constructor_calldata)++`]
* xref:universal_deployer-udc_calculate_contract_address_not_from_zero[`++udc_calculate_contract_address_not_from_zero(salt, class_hash, constructor_calldata, caller_address, deployer_address)++`]
--
...
[.contract-item]
[[universal_deployer-calculate_contract_address_from_deploy_syscall]]
...
[.contract-item]
[[universal_deployer-udc_calculate_contract_address_from_zero]]
==== `[.contract-item-name]#++udc_calculate_contract_address_from_zero++#++(salt: felt252, class_hash: ClassHash, constructor_calldata: Span<felt252>) → ContractAddress++` [.item-kind]#function#

Returns the calculated address for origin-independent deployments (when `from_zero` is `true` in {udc-deploy_contract}).

[.contract-item]
[[universal_deployer-udc_calculate_contract_address_not_from_zero]]
==== `[.contract-item-name]#++udc_calculate_contract_address_not_from_zero++#++(salt: felt252, class_hash: ClassHash, constructor_calldata: Span<felt252>, caller_address: ContractAddress, deployer_address: ContractAddress) → ContractAddress++` [.item-kind]#function#
...
This function hashes the `salt` with `caller_address` and passes the hashed salt to to the inner {deploy_syscall} as the `contract_address_salt` argument.
