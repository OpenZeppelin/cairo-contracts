...
use of preset contracts are subject to the terms of the https://github.com/OpenZeppelin/cairo-contracts?tab=MIT-1-ov-file#readme[MIT License].
...
:presets_dir: link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v2.0.0-alpha.0/packages/presets/src[presets directory]
