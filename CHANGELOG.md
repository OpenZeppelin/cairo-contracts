...
- Embeddable impls for ERC2981 component (#1173)
  ...
  - `ERC2981AdminOwnable` exposing admin functions for a token that implements Ownable component
  - `ERC2981AdminAccessControl` exposing admin functions for a token that implements AccessControl component
