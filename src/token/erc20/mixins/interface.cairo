...
// OpenZeppelin Contracts for Cairo v0.8.0 (token/erc20/mixins/interface.cairo)

use starknet::ContractAddress;

#[starknet::interface]
trait IERC20Mixin<TState> {
    // IERC20
...
#[starknet::interface]
trait IERC20MetadataMixin<TState> {
    // IERC20
    fn total_supply(self: @TState) -> u256;
    fn balance_of(self: @TState, account: ContractAddress) -> u256;
    fn allowance(self: @TState, owner: ContractAddress, spender: ContractAddress) -> u256;
...
#[starknet::interface]
trait IERC20SafeAllowanceMixin<TState> {
    // IERC20
    fn total_supply(self: @TState) -> u256;
    fn balance_of(self: @TState, account: ContractAddress) -> u256;
    fn allowance(self: @TState, owner: ContractAddress, spender: ContractAddress) -> u256;
...
#[starknet::interface]
trait IERC20MetadataSafeAllowanceMixin<TState> {
    // IERC20
    fn total_supply(self: @TState) -> u256;
    fn balance_of(self: @TState, account: ContractAddress) -> u256;
    fn allowance(self: @TState, owner: ContractAddress, spender: ContractAddress) -> u256;
