...
Presets are ready-to-use contracts that you can deploy right away. They also serve as examples of how to use library modules. [Read more about presets](https://docs.openzeppelin.com/contracts-cairo/0.5.0/extensibility#presets).
...
[Read more about libraries](https://docs.openzeppelin.com/contracts-cairo/0.5.0/extensibility#libraries).
...
- [Accounts](https://docs.openzeppelin.com/contracts-cairo/0.5.0/accounts)
- [ERC20](https://docs.openzeppelin.com/contracts-cairo/0.5.0/erc20)
- [ERC721](https://docs.openzeppelin.com/contracts-cairo/0.5.0/erc721)
- [Contract extensibility pattern](https://docs.openzeppelin.com/contracts-cairo/0.5.0/extensibility)
- [Proxies and upgrades](https://docs.openzeppelin.com/contracts-cairo/0.5.0/proxies)
- [Security](https://docs.openzeppelin.com/contracts-cairo/0.5.0/security)
- [Utilities](https://docs.openzeppelin.com/contracts-cairo/0.5.0/utilities)
...
See [Memoization](https://docs.openzeppelin.com/contracts-cairo/0.5.0/utilities#memoization) in the Utilities documentation for a more thorough example on caching contracts.
