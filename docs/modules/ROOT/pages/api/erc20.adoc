...
This internal function does not include permissions and can be useful for instances like setting automatic allowances on behalf of other addresses.
...
This internal function does not include permissions and can be useful for instances like implementing automatic token fees, slashing mechanisms, etc.
