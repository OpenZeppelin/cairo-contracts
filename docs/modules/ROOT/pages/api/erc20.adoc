...
This internal function does not include permissions but can be useful for instances like setting automatic allowances on behalf of other addresses.
...
This internal function does not include permissions but can be useful for instances like implementing automatic token fees, slashing mechanisms, etc.
