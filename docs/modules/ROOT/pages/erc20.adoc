...
:custom-decimals: xref:./erc20.adoc#customizing-decimals[Customizing decimals]
...
:dual-interfaces: xref:./interfaces.adoc#dual-interfaces[Dual interfaces]
...
:dual-interface: xref:./interfaces.adoc#dual-interfaces[dual interface]
