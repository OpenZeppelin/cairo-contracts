...
This internal function is equivalent to <<ERC20-approve,ERC20::approve>>, and can be used to e.g. set automatic allowances on behalf of other addresses.
...
This internal function is equivalent to <<ERC20-transfer,ERC20::transfer>>, and can be used to e.g. implement automatic token fees, slashing mechanisms, etc.
