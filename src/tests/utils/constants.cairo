...
pub(crate) mod secp256k1 {
    use openzeppelin_utils::tests_utils::signing::{Secp256k1KeyPair, get_secp256k1_keys_from};
...
pub(crate) mod stark {
    use openzeppelin_utils::tests_utils::signing::{StarkKeyPair, get_stark_keys_from};
