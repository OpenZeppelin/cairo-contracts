...
func ERC721_mint{
    ...
    let (new_balance: Uint256) = SafeMath.uint256_checked_add(balance, Uint256(1, 0))
...
func ERC721_burn{
    ...
    let (balance: Uint256) = ERC721_balances.read(owner)
    let (new_balance: Uint256) = SafeMath.uint256_checked_sub_le(balance, Uint256(1, 0))
...
func _transfer{
    ...
    let (new_balance: Uint256) = SafeMath.uint256_checked_sub_le(owner_bal, Uint256(1, 0))
    ERC721_balances.write(from_, new_balance)

    # Increase receiver balance
    let (receiver_bal) = ERC721_balances.read(to)
    let (new_balance: Uint256) = SafeMath.uint256_checked_add(receiver_bal, Uint256(1, 0))
    ERC721_balances.write(to, new_balance)
