use openzeppelin::tests::mocks::erc721_receiver_mocks::{CamelERC721ReceiverMock, CamelERC721ReceiverPanicMock};
use openzeppelin::tests::mocks::erc721_receiver_mocks::{SnakeERC721ReceiverMock, SnakeERC721ReceiverPanicMock};
...
use openzeppelin::token::erc721::interface::{IERC721ReceiverCamelDispatcher, IERC721ReceiverCamelDispatcherTrait};
use openzeppelin::token::erc721::interface::{IERC721ReceiverDispatcher, IERC721ReceiverDispatcherTrait};
