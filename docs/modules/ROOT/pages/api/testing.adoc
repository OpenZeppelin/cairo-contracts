...
* xref:#testing-events-assert_no_events_from[`++assert_no_events_from(self, from_address)++`]
* xref:#testing-events-assert_number_of_events_from[`++assert_number_of_events_from(self, from_address, expected)++`]
* xref:#testing-events-assert_only_one_event_from[`++assert_only_one_event_from(self, from_address)++`]
...
[.contract-item]
[[testing-events-assert_no_events_from]]
==== `[.contract-item-name]#++assert_no_events_from++#++(ref self: EventSpy, from_address: ContractAddress)++` [.item-kind]#function#

Ensures that there are no events emitted from the given address.

[.contract-item]
[[testing-events-assert_number_of_events_from]]
==== `[.contract-item-name]#++assert_number_of_events_from++#++(ref self: EventSpy, from_address: ContractAddress, expected: u32)++` [.item-kind]#function#

Ensures that the number of events emitted from the given address is equal to `expected`.

[.contract-item]
[[testing-events-assert_only_one_event_from]]
==== `[.contract-item-name]#++assert_only_one_event_from++#++(ref self: EventSpy, from_address: ContractAddress)++` [.item-kind]#function#
