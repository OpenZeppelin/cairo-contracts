...
Start by {setup_project} and installing the OpenZeppelin Contracts for Cairo library.
Copy the target preset contract from the library's presets directory and paste it in the new project's `src/lib.cairo`.
