...
use openzeppelin_token::tests::mocks::account_mocks::DualCaseAccountMock;
...
use openzeppelin_utils::test_utils::constants::{SUPPLY, ZERO, OWNER, PUBKEY, RECIPIENT};
...
fn assert_event_delegate_changed(
    ...
    let event = test_utils::pop_log::<ERC20VotesComponent::Event>(contract).unwrap();
