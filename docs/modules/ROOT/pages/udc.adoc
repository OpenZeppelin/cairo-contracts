...
:calculate_contract_address_from_deploy_syscall: xref:/utilities.adoc#universal_deployer-calculate_contract_address_from_deploy_syscall[calculate_contract_address_from_deploy_syscall]
:utils-api: xref:/utilities.adoc#universal_deployer[Utilities API]
