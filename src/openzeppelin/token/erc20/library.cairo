...
namespace ERC20:
    ...
    func increase_allowance{
        ...
        with_attr error_message("ERC20: allowance overflow"):
            let (new_allowance: Uint256) = SafeMath.uint256_checked_add(current_allowance, added_value)
        end
    ...
    func decrease_allowance{
        ...
        with_attr error_message("ERC20: allowance below zero"):
            let (new_allowance: Uint256) = SafeMath.uint256_checked_sub_le(current_allowance, subtracted_value)
        end
    ...
    func _mint{
        ...
        with_attr error_message("ERC20: mint overflow"):
            let (new_supply: Uint256) = SafeMath.uint256_checked_add(supply, amount)
        end
        ...
        let (new_balance: Uint256) = SafeMath.uint256_checked_add(balance, amount)
    ...
    func _burn{
        ...
        with_attr error_message("ERC20: burn amount exceeds balance"):
            let (new_balance: Uint256) = SafeMath.uint256_checked_sub_le(balance, amount)
        end

        ERC20_balances.write(account, new_balance)

        let (supply: Uint256) = ERC20_total_supply.read()
        let (new_supply: Uint256) = SafeMath.uint256_checked_sub_le(supply, amount)
        ERC20_total_supply.write(new_supply)
    ...
    func _transfer{
        ...
        with_attr error_message("ERC20: transfer amount exceeds balance"):
            let (new_sender_balance: Uint256) = SafeMath.uint256_checked_sub_le(sender_balance, amount)
        end
        ...
        let (new_recipient_balance: Uint256) = SafeMath.uint256_checked_add(recipient_balance, amount)
    ...
    func _spend_allowance{
        ...
        if is_infinite == FALSE:
            with_attr error_message("ERC20: insufficient allowance"):
                let (new_allowance: Uint256) = SafeMath.uint256_checked_sub_le(current_allowance, amount)
            end
