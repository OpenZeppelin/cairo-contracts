...
- `into_base_16_string_no_padding` function to the test helpers to accommodate to Starknet Foundry output where addresses and selectors don't have trailing zeros after `0x` (#1137)
