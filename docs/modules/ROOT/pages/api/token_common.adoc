...
[.contract]
[[IERC2981]]
=== `++IERC2981++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v3.0.0-alpha.0/packages/interfaces/src/token/erc2981.cairo[{github-icon},role=heading-link]
...
[.contract]
[[IERC2981Info]]
=== `++IERC2981Info++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v3.0.0-alpha.0/packages/interfaces/src/token/erc2981.cairo[{github-icon},role=heading-link]
...
[.contract]
[[IERC2981Admin]]
=== `++IERC2981Admin++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v3.0.0-alpha.0/packages/interfaces/src/token/erc2981.cairo[{github-icon},role=heading-link]
