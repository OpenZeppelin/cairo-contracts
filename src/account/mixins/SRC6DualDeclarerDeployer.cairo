...
mod SRC6DualDeclarerDeployer {
    ...
    #[embeddable_as(SRC6DualDeclarerDeployerImpl)]
    impl ISRC6DualDeclarerDeployer<
        TContractState, +HasComponent<TContractState>
    > of interface::ISRC6DualDeclarerDeployer<ComponentState<TContractState>> {
