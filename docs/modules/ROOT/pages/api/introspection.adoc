...
[.contract]
[[ISRC5]]
=== `++ISRC5++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v4.0.0-alpha.1/packages/interfaces/src/introspection.cairo[{github-icon},role=heading-link]
...
[.contract]
[[SRC5Component]]
=== `++SRC5Component++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v4.0.0-alpha.1/packages/introspection/src/src5.cairo[{github-icon},role=heading-link]
