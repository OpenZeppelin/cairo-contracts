...
trait DualCaseAccountTrait {
    fn is_valid_signature(self: @DualCaseAccount, hash: felt252, signature: Array<felt252>) -> felt252;
...
impl DualCaseAccountImpl of DualCaseAccountTrait {
    fn is_valid_signature(self: @DualCaseAccount, hash: felt252, signature: Array<felt252>) -> felt252 {
        ...
        try_selector_with_fallback(
            *self.contract_address, selectors::is_valid_signature, selectors::isValidSignature, args.span()
        )
            .unwrap_and_cast()
    }

    fn supports_interface(self: @DualCaseAccount, interface_id: felt252) -> felt252 {
        let mut args = ArrayTrait::new();
