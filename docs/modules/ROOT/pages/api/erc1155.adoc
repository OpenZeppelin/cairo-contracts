...
the latter implements `IERC1155Receiver`, and checks if it is an account otherwise.
...
This function is called whenever an IERC1155 `token_id` token is transferred to this IERC1155Receiver implementer
