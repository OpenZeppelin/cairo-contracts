...
[.contract]
[[IUpgradeable]]
=== `++IUpgradeable++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.8.0-beta.1/src/upgrades/interface.cairo#L3[{github-icon},role=heading-link]
...
[.contract]
[[Upgradeable]]
=== `++Upgradeable++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.8.0-beta.1/src/upgrades/upgradeable.cairo[{github-icon},role=heading-link]
