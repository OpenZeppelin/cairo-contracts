...
:mixin-impl: xref:components.adoc#mixins[Embeddable Mixin Implementations]
...
[.sub-index2#OwnableComponent-Embeddable-Impls-OwnableCamelOnlyImpl]
...
[.sub-index2#OwnableComponent-Embeddable-Impls-OwnableTwoStepCamelOnlyImpl]
