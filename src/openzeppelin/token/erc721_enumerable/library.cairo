...
func _add_token_to_all_tokens_enumeration{
    ...
    let (new_supply: Uint256) = SafeMath.uint256_checked_add(supply, Uint256(1, 0))
...
func _remove_token_from_all_tokens_enumeration{
    ...
    alloc_locals
    let (supply: Uint256) = ERC721_Enumerable_all_tokens_len.read()
    let (last_token_index: Uint256) = SafeMath.uint256_checked_sub_le(supply, Uint256(1, 0))
    ...
    let (new_supply: Uint256) = SafeMath.uint256_checked_sub_le(supply, Uint256(1, 0))
    ERC721_Enumerable_all_tokens_len.write(new_supply)
    return ()
end
...
func _remove_token_from_owner_enumeration{
    ...
    let (last_token_index) = SafeMath.uint256_checked_sub_le(last_token_index, Uint256(1, 0))
