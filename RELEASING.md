...
(7) Finally, go to the [Documentation](https://github.com/OpenZeppelin/docs/tree/main/content/contracts-cairo) repo and update the docs to support the new version.
