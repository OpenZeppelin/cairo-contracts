...
To deploy the Contracts for Cairo account variant, compile the contract and declare the class hash because custom accounts are likely not declared on the network.
This means that you'll need an account already deployed to the network.
