...
[.contract]
[[ISRC5]]
=== `++ISRC5++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.8.0-beta.1/src/introspection/interface.cairo#L7[{github-icon},role=heading-link]
...
[.contract]
[[SRC5]]
=== `++SRC5++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.8.0-beta.1/src/introspection/src5.cairo[{github-icon},role=heading-link]
