...
impl AllowedComponents {
    pub fn from_str(s: &str) -> Result<Self, Diagnostic> {
        match s {
            ...
            "ERC1155URIStorage" => Ok(AllowedComponents::ERC1155URIStorage),
            ...
            "ERC20FlashMint" => Ok(AllowedComponents::ERC20FlashMint),
    ...
    pub fn get_info(&self) -> ComponentInfo<'static> {
        match self {
            ...
            AllowedComponents::ERC1155URIStorage => ComponentInfo {
                name: "ERC1155URIStorageComponent",
                path: "openzeppelin_token::erc1155::extensions::ERC1155URIStorageComponent",
                storage: "erc1155_uri_storage",
                event: "ERC1155URIStorageEvent",
                has_initializer: false,
                has_immutable_config: false,
                internal_impls: vec!["InternalImpl"],
            },
            ...
            AllowedComponents::ERC20FlashMint => ComponentInfo {
                name: "ERC20FlashMintComponent",
                path: "openzeppelin_token::erc20::extensions::erc20_flash_mint::ERC20FlashMintComponent",
