...
:replace_class_syscall: https://book.cairo-lang.org/appendix-08-system-calls.html/#replace_class[replace_class]
:upgradeable: https://github.com/OpenZeppelin/cairo-contracts/blob/release-v2.0.0-alpha.1/packages/upgrades/src/upgradeable.cairo[Upgradeable]
:ownable: xref:access.adoc#ownership_and_ownable[Ownable]
:i_upgradeable: xref:api/upgrades.adoc#IUpgradeable[IUpgradeable]
:library_calls: https://book.cairo-lang.org/appendix-08-system-calls.html/#library_call[library calls]
