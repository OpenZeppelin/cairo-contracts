...
fn compute_hash_on_elements(mut data: Array::<felt252>) -> felt252 {
...
fn calculate_contract_address_from_hash(
    ...
    let raw_address = compute_hash_on_elements(data);
    ...
    contract_address_try_from_felt252(felt_addr).unwrap()
}
