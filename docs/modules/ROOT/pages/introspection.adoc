...
#[starknet::contract]
mod MyContract {
    use openzeppelin::interfaces::accounts as interface;
    use openzeppelin_introspection::src5::SRC5Component;
...
mod MyContract {
    use openzeppelin::interfaces::accounts as interface;
    use openzeppelin::interfaces::introspection::ISRC5DispatcherTrait;
    use openzeppelin::interfaces::introspection::ISRC5Dispatcher;
