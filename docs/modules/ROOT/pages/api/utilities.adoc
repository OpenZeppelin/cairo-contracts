...
[.contract]
[#IERC6372Clock]
=== `++IERC6372Clock++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v2.0.0-alpha.0/packages/utils/src/contract_clock.cairo[{github-icon},role=heading-link]
...
Interface of the IERC6372Clock standard.
