...
mod ERC20Pausable {
    ...
    use openzeppelin::interfaces::erc20::{IERC20, IERC20CamelOnly};
    use starknet::ContractAddress;
...
Next, the contract includes the {erc20-component} implementations; however, `ERC20Impl` and `ERC20CamelOnlyImpl` are *not* embedded.
