...
[.contract]
[[ITimelock]]
=== `++ITimelock++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.18.0/packages/governance/src/timelock/interface.cairo[{github-icon},role=heading-link]
...
=== `++TimelockControllerComponent++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.18.0/packages/governance/src/timelock/timelock_controller.cairo[{github-icon},role=heading-link]
...
[.contract]
[[IVotes]]
=== `++IVotes++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.18.0/packages/governance/src/votes/interface.cairo[{github-icon},role=heading-link]
...
[.contract]
[[VotesComponent]]
=== `++VotesComponent++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.18.0/packages/governance/src/votes/votes.cairo[{github-icon},role=heading-link]
...
[.contract]
[[VotingUnitsTrait]]
=== `++VotingUnitsTrait++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.18.0/packages/governance/src/votes/votes.cairo[{github-icon},role=heading-link]
