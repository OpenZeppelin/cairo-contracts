...
Deletes `erc165_id` value from the storage variable `ERC165_supported_interfaces` in the calling contract's storage.

This function is designed to be used in a ERC165-to-SRC5 migration process.
