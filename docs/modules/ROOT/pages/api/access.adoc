...
[.contract]
[[AccessControl]]
=== `++AccessControl++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.8.0-beta.0/src/access/accesscontrol/accesscontrol.cairo[{github-icon},role=heading-link]
