...
[.contract-index#ERC20Component-Embeddable-MixinImpl]
.{mixin-impls}
--
.ERC20MixinImpl
...
.Events
--
* xref:#ERC20VotesComponent-DelegateChanged[`++DelegateChanged([key] delegator, [key] from_delegate, [key] to_delegate)++`]
* xref:#ERC20VotesComponent-DelegateVotesChanged[`++DelegateVotesChanged([key] delegate, previous_votes, new_votes)++`]
--
...
==== `[.contract-item-name]#++DelegateVotesChanged++#++([key] delegate: ContractAddress, previous_votes: u256, new_votes: u256)++` [.item-kind]#event#
...
* xref:#ERC20Component-Embeddable-MixinImpl[`++ERC20MixinImpl++`]
--
