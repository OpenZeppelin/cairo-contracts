...
* xref:#ERC721-_set_base_uri[`++_set_base_uri(self, base_uri)++`]
* xref:#ERC721-_base_uri[`++_base_uri(self)++`]
--
...
Mints `token_ids` tokens to `recipient` and set the `base_uri`.
