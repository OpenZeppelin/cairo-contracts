...
[.contract]
[#ERC6372Clock]
=== `++ERC6372Clock++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v2.0.0-alpha.1/packages/utils/src/contract_clock.cairo[{github-icon},role=heading-link]
