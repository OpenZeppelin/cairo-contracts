...
[.contract]
[[IUpgradeable]]
=== `++IUpgradeable++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v1.1.0/packages/upgrades/src/interface.cairo[{github-icon},role=heading-link]
...
[.contract]
[[IUpgradeAndCall]]
=== `++IUpgradeAndCall++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v1.1.0/packages/upgrades/src/interface.cairo[{github-icon},role=heading-link]
...
=== `++UpgradeableComponent++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v1.1.0/packages/upgrades/src/upgradeable.cairo[{github-icon},role=heading-link]
