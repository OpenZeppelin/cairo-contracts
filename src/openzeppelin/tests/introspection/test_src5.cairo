...
fn test_default_behavior() {
    let supports_default_interface: bool = SRC5::SRC5Impl::supports_interface(@STATE(), ISRC5_ID);
...
fn test_not_registered_interface() {
    let supports_unregistered_interface: bool = SRC5::SRC5Impl::supports_interface(
        @STATE(), OTHER_ID
    );
