...
=== `++InitializableComponent++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.18.0/packages/security/src/initializable.cairo[{github-icon},role=heading-link]
...
[.contract]
[[PausableComponent]]
=== `++PausableComponent++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.18.0/packages/security/src/pausable.cairo[{github-icon},role=heading-link]
...
=== `++ReentrancyGuardComponent++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.18.0/packages/security/src/reentrancyguard.cairo[{github-icon},role=heading-link]
