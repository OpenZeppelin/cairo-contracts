...
NOTE: The function call comes from the calling contract itself and not the account.
...
The extra call would be executed from the account and can't be front-ran.
