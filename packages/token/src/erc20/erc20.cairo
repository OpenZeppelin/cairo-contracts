...
// OpenZeppelin Contracts for Cairo v4.0.0-alpha.1 (token/src/erc20/erc20.cairo)
...
/// (https://docs.openzeppelin.com/contracts-cairo/4.0.0-alpha.1/guides/erc20-supply)
/// for examples.
#[starknet::component]
