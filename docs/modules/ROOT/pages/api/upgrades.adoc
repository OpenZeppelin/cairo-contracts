...
Interface of an upgradeable contract that also offers the ability to upgrade and call a function in the upgraded context.

[.contract-index]
.Functions
--
* xref:#IUpgradeAndCall-upgrade[`++upgrade(new_class_hash)++`]
