...
* xref:deployments-udc_calculate_contract_address_from_zero[`++udc_calculate_contract_address_from_zero(salt, class_hash, constructor_calldata)++`]
* xref:deployments-udc_calculate_contract_address_not_from_zero[`++udc_calculate_contract_address_not_from_zero(salt, class_hash, constructor_calldata, caller_address, deployer_address)++`]
--
...
[.contract-item]
[[deployments-udc_calculate_contract_address_from_zero]]
...
[.contract-item]
[[deployments-udc_calculate_contract_address_not_from_zero]]
