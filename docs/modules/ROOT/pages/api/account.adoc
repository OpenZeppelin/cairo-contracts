...
[.contract]
[[ISRC6]]
=== `++ISRC6++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.16.0/packages/account/src/interface.cairo[{github-icon},role=heading-link]
...
[.contract]
[[AccountComponent]]
=== `++AccountComponent++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.16.0/packages/account/src/account.cairo[{github-icon},role=heading-link]
...
[.contract]
[[EthAccountComponent]]
=== `++EthAccountComponent++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.16.0/packages/account/src/eth_account.cairo[{github-icon},role=heading-link]
...
[.contract]
[[IOutsideExecutionV2]]
=== `++IOutsideExecutionV2++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.16.0/packages/account/src/extensions/src9/interface.cairo[{github-icon},role=heading-link]

```cairo
use openzeppelin::account::extensions::src9::IOutsideExecutionV2;
```
...
.Functions
--
* xref:#IOutsideExecutionV2-execute_from_outside_v2[`++execute_from_outside_v2(outside_execution, signature)++`]
* xref:#IOutsideExecutionV2-is_valid_outside_execution_nonce[`++is_valid_outside_execution_nonce(nonce)++`]
--

[#IOutsideExecutionV2-Functions]
==== Functions

[.contract-item]
[[IOutsideExecutionV2-execute_from_outside_v2]]
...
[.contract-item]
[[IOutsideExecutionV2-is_valid_outside_execution_nonce]]
...
=== `++OutsideExecutionComponent++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.16.0/packages/account/src/extensions/src9/src9.cairo[{github-icon},role=heading-link]

```cairo
use openzeppelin::account::extensions::src9::OutsideExecutionComponent;
```

OutsideExecution component implementing xref:IOutsideExecutionV2[`IOutsideExecutionV2`].

[.contract-index#OutsideExecutionComponent-Embeddable-Impls]
.Embeddable Implementations
--
[.sub-index#OutsideExecutionComponent-Embeddable-Impls-OutsideExecutionV2Impl]
.OutsideExecutionV2Impl

* xref:#OutsideExecutionComponent-execute_from_outside_v2[`++execute_from_outside_v2(self, outside_execution, signature)++`]
* xref:#OutsideExecutionComponent-is_valid_outside_execution_nonce[`++is_valid_outside_execution_nonce(self, nonce)++`]
--
...
* xref:#OutsideExecutionComponent-initializer[`++initializer(self)++`]
--

[#OutsideExecutionComponent-Embeddable-Functions]
==== Embeddable functions

[.contract-item]
[[OutsideExecutionComponent-execute_from_outside_v2]]
...
[.contract-item]
[[OutsideExecutionComponent-is_valid_outside_execution_nonce]]
...
[#OutsideExecutionComponent-Internal-Functions]
==== Internal functions

[.contract-item]
[[OutsideExecutionComponent-initializer]]
...
[.contract]
[[AccountUpgradeable]]
=== `++AccountUpgradeable++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.16.0/packages/presets/src/account.cairo[{github-icon},role=heading-link]
...
=== `++EthAccountUpgradeable++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.16.0/packages/presets/src/eth_account.cairo[{github-icon},role=heading-link]
