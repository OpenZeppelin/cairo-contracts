...
Compiling lib(openzeppelin) openzeppelin v0.8.0-beta.1 (~/cairo-contracts/Scarb.toml)
Compiling starknet-contract(openzeppelin) openzeppelin v0.8.0-beta.1 (~/cairo-contracts/Scarb.toml)
