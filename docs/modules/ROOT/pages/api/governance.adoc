...
:Cancelled: xref:ITimelock-Cancelled[Cancelled]
:MinDelayChange: xref:ITimelock-MinDelayChange[MinDelayChange]
...
[.contract]
[[ITimelock]]
=== `++ITimelock++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.14.0/src/governance/timelock/interface.cairo[{github-icon},role=heading-link]
...
=== `++TimelockControllerComponent++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.14.0/src/governance/timelock/timelock_controller.cairo[{github-icon},role=heading-link]
...
* xref:api/erc721.adoc#ERC721ReceiverComponent-Embeddable-Impls[`++ERC721ReceiverImpl++`]
* xref:api/erc721.adoc#ERC721ReceiverComponent-Embeddable-Impls[`++ERC721ReceiverCamelImpl++`]
* xref:api/erc1155.adoc#ERC1155ReceiverComponent-Embeddable-Impls[`++ERC1155ReceiverImpl++`]
* xref:api/erc1155.adoc#ERC1155ReceiverComponent-Embeddable-Impls[`++ERC1155ReceiverCamelImpl++`]
--
...
* xref:#TimelockControllerComponent-is_operation[`++is_operation(id) -> bool++`]
* xref:#TimelockControllerComponent-is_operation_pending[`++is_operation_pending(id) -> bool++`]
* xref:#TimelockControllerComponent-is_operation_ready[`++is_operation_ready(id) -> bool++`]
* xref:#TimelockControllerComponent-is_operation_done[`++is_operation_done(id) -> bool++`]
* xref:#TimelockControllerComponent-get_timestamp[`++get_timestamp(id) -> u64++`]
* xref:#TimelockControllerComponent-get_operation_state[`++get_operation_state(id) -> OperationState++`]
* xref:#TimelockControllerComponent-get_min_delay[`++get_min_delay() -> u64++`]
* xref:#TimelockControllerComponent-hash_operation[`++hash_operation(call, predecessor, salt) -> felt252++`]
* xref:#TimelockControllerComponent-hash_operation_batch[`++hash_operation_batch(calls, predecessor, salt) -> felt252++`]
...
.ERC721ReceiverImpl
* xref:api/erc721.adoc#ERC721ReceiverComponent-on_erc721_received[`++on_erc721_received(self, operator, from, token_id, data) -> felt252++`]

.ERC721ReceiverCamelImpl
* xref:api/erc721.adoc#ERC721ReceiverComponent-onERC721Received[`++onERC721Received(self, operator, from, tokenId, data) -> felt252++`]

.ERC1155ReceiverImpl
* xref:api/erc1155.adoc#ERC721ReceiverComponent-on_erc1155_received[`++on_erc1155_received(self, operator, from, token_id, value, data) -> felt252++`]
* xref:api/erc1155.adoc#ERC721ReceiverComponent-on_erc1155_batch_received[`++on_erc1155_batch_received(self, operator, from, token_ids, values, data) -> felt252++`]

.ERC1155ReceiverCamelImpl
* xref:api/erc1155.adoc#ERC721ReceiverComponent-onERC1155Received[`++onERC1155Received(self, operator, from, tokenId, value, data) -> felt252++`]
* xref:api/erc1155.adoc#ERC721ReceiverComponent-onERC1155BatchReceived[`++onERC1155BatchReceived(self, operator, from, tokenIds, values, data) -> felt252++`]
--
...
* xref:#TimelockControllerComponent-Cancelled[`++Cancelled(id)++`]
* xref:#TimelockControllerComponent-MinDelayChange[`++MinDelayChange(old_duration, new_duration)++`]
--
...
[.contract-item]
[[TimelockControllerComponent-Cancelled]]
==== `[.contract-item-name]#++Cancelled++#++(id: felt252)++` [.item-kind]#event#

Emitted when operation `id` is cancelled.

[.contract-item]
[[TimelockControllerComponent-MinDelayChange]]
==== `[.contract-item-name]#++MinDelayChange++#++(old_duration: u64, new_duration: u64)++` [.item-kind]#event#
