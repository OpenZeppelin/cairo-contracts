...
and the token ID. For example, the contract URI pass:[<code>https://token-cdn-domain/</code>] would be
returned as pass:[<code>https://token-cdn-domain/123</code>] for token ID 123.
