...
CAUTION: Before version 4.0.0, class hashes were computed using the `scarb --dev` profile.
...
:presets_dir: link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v4.0.0/packages/presets/src[presets directory]
