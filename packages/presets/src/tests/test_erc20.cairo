...
use openzeppelin_presets::tests::mocks::erc20_mocks::SnakeERC20Mock;
use openzeppelin_token::erc20::interface::{IERC20CamelDispatcher, IERC20CamelDispatcherTrait};
use openzeppelin_token::erc20::interface::{IERC20Dispatcher, IERC20DispatcherTrait};
use openzeppelin_token::tests::erc20::common::{
...
fn setup_dispatcher_with_event() -> ERC20UpgradeableABIDispatcher {
    ...
    let address = test_utils::deploy(ERC20Upgradeable::TEST_CLASS_HASH, calldata);
...
fn setup_dispatcher() -> ERC20UpgradeableABIDispatcher {
    ...
    test_utils::drop_event(dispatcher.contract_address); // Ownable `OwnershipTransferred`
    test_utils::drop_event(dispatcher.contract_address); // ERC20 `Transfer`
    dispatcher
}
