...
=== `++InitializableComponent++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.12.0/src/security/initializable.cairo[{github-icon},role=heading-link]
...
[.contract]
[[PausableComponent]]
=== `++PausableComponent++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.12.0/src/security/pausable.cairo[{github-icon},role=heading-link]
...
=== `++ReentrancyGuardComponent++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.12.0/src/security/reentrancyguard.cairo[{github-icon},role=heading-link]
