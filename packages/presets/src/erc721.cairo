...
// OpenZeppelin Contracts for Cairo v3.0.0 (presets/src/erc721.cairo)
...
pub mod ERC721Upgradeable {
    ...
    use openzeppelin_token::erc721::{ERC721Component, ERC721HooksEmptyImpl, ERC721OwnerOfDefaultImpl};
