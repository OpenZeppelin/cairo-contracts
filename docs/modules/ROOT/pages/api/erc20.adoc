...
[.contract]
[[IERC20]]
=== `++IERC20++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.8.0-rc.0/src/token/erc20/interface.cairo[{github-icon},role=heading-link]
...
[.contract]
[[ERC20]]
=== `++ERC20++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v0.8.0-rc.0/src/token/erc20/erc20.cairo[{github-icon},role=heading-link]
