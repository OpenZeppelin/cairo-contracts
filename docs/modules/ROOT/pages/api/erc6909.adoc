...
[.hljs-theme-dark]
```cairo
use openzeppelin::interfaces::erc6909::IERC6909;
```
...
[.hljs-theme-dark]
```cairo
use openzeppelin::interfaces::erc6909::IERC6909ContentUri;
```
...
[.hljs-theme-dark]
```cairo
use openzeppelin::interfaces::erc6909::IERC6909Metadata;
```
...
[.hljs-theme-dark]
```cairo
use openzeppelin::interfaces::erc6909::IERC6909TokenSupply;
```
