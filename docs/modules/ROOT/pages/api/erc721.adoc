...
:inner-ierc721: xref:api/erc721.adoc#IERC721[SRC5 ID]
:inner-ierc721metadata: xref:api/erc721.adoc#IERC721Metadata[SRC5 ID]
:inner-ierc721receiver: xref:api/erc721.adoc#IERC721Receiver[SRC5 ID]
...
awareness of the ERC721 protocol, see {receiving-tokens}.
...
This function is equivalent to <<IERC721-safe_transfer_from,IERC721::safe_transfer_from>>, and can be used to e.g. implement alternative mechanisms to perform signature-based token transfers.
