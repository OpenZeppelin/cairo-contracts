...
Importing this trait allows to append a serialized representation of a Cairo data structure already
...
WARNING: This method doesn't currently work for components events that are not flattened
