...
// OpenZeppelin Contracts for Cairo v3.0.0-alpha.0 (governance/src/votes/votes.cairo)
...
/// (https://docs.openzeppelin.com/contracts-cairo/3.0.0-alpha.0/governance.html#usage_2)
