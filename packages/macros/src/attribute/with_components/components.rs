...
impl AllowedComponents {
    ...
    pub fn get_info(&self) -> ComponentInfo<'static> {
        match self {
            ...
            AllowedComponents::ERC1155Supply => ComponentInfo {
                name: "ERC1155SupplyComponent",
                path: "openzeppelin_token::erc1155::extensions::ERC1155SupplyComponent",
                storage: "erc1155_supply",
                event: "ERC1155SupplyEvent",
                has_initializer: false,
                has_immutable_config: false,
                internal_impls: vec!["InternalImpl"],
            },
