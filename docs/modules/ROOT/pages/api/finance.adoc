...
[.contract]
[[IVesting]]
=== `++IVesting++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v4.0.0/packages/interfaces/src/finance/vesting.cairo[{github-icon},role=heading-link]
...
[.contract]
[[VestingComponent]]
=== `++VestingComponent++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v4.0.0/packages/finance/src/vesting/vesting.cairo[{github-icon},role=heading-link]
...
=== `++LinearVestingSchedule++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v4.0.0/packages/finance/src/vesting/vesting.cairo[{github-icon},role=heading-link]
...
[.contract]
[[VestingWallet]]
=== `++VestingWallet++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v4.0.0/packages/presets/src/vesting.cairo[{github-icon},role=heading-link]
