...
To ease the readability of Cairo contracts, this project includes reusable link:../src/openzeppelin/utils/constants.cairo[constants variables] like `UINT8_MAX`, or EIP165 interface IDs such as `IERC165_ID` or `IERC721_ID`.
For more information on how interface ids are calculated, see the link:../docs/Introspection.md#interface-calculations[ERC165 documentation].
...
See link:../docs/Account.md#mocksigner-utility[MockSigner utility] for more information.
