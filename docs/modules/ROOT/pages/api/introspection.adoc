...
[.contract]
[[ISRC5]]
=== `++ISRC5++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v3.0.0/packages/interfaces/src/introspection.cairo[{github-icon},role=heading-link]
...
[.contract]
[[SRC5Component]]
=== `++SRC5Component++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v3.0.0/packages/introspection/src/src5.cairo[{github-icon},role=heading-link]
