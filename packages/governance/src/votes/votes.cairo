...
// OpenZeppelin Contracts for Cairo v2.0.0-alpha.0 (governance/src/votes/votes.cairo)
...
/// (https://docs.openzeppelin.com/contracts-cairo/2.0.0-alpha.0/governance.html#usage_2)
...
pub mod VotesComponent {
    ...
    use openzeppelin_utils::contract_clock::{ClockReference, ERC6372TimestampClock};
