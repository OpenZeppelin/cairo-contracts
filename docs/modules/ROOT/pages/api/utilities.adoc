...
[.contract]
[#IERC6372]
=== `++IERC6372++` link:https://github.com/OpenZeppelin/cairo-contracts/blob/release-v2.0.0-alpha.0/packages/utils/src/contract_clock.cairo[{github-icon},role=heading-link]
...
Interface of the IERC6372 standard.
...
* xref:#IERC6372-CLOCK_REFERENCE[`++CLOCK_REFERENCE()++`]
--
...
[.contract-item]
[[IERC6372-CLOCK_REFERENCE]]
==== `[.contract-item-name]#++CLOCK_REFERENCE++#++() → ClockReference++` [.item-kind]#external#
...
Implementation of the `IERC6372` trait that uses the block number as its clock reference.

[.contract-item]
[[contract_clock-ERC6372TimestampClock]]
==== `[.contract-item-name]#++ERC6372TimestampClock++#` [.item-kind]#impl#

Implementation of the `IERC6372` trait that uses the block timestamp as its clock reference.
