...
use openzeppelin_token::tests::mocks::erc1155_mocks::{CamelERC1155Mock, SnakeERC1155Mock};
use openzeppelin_token::tests::mocks::erc1155_mocks::{CamelERC1155PanicMock, SnakeERC1155PanicMock};
...
fn setup_snake() -> (DualCaseERC1155, IERC1155Dispatcher, ContractAddress) {
    ...
    let target = test_utils::deploy(SnakeERC1155Mock::TEST_CLASS_HASH, calldata);
    (
...
fn setup_camel() -> (DualCaseERC1155, IERC1155CamelDispatcher, ContractAddress) {
    ...
    calldata.append_serde(TOKEN_ID);
    calldata.append_serde(TOKEN_VALUE);
    let target = test_utils::deploy(CamelERC1155Mock::TEST_CLASS_HASH, calldata);
    (
        DualCaseERC1155 { contract_address: target },
...
fn setup_erc1155_panic() -> (DualCaseERC1155, DualCaseERC1155) {
    let snake_target = test_utils::deploy(SnakeERC1155PanicMock::TEST_CLASS_HASH, array![]);
    let camel_target = test_utils::deploy(CamelERC1155PanicMock::TEST_CLASS_HASH, array![]);
    (
