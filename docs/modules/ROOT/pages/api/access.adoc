...
documented here are contained in the `openzeppelin::interfaces` package version `v{current_openzeppelin::interfaces_version}`.
...
```cairo
use openzeppelin::interfaces::accesscontrol::IAccessControl;
```
...
```cairo
use openzeppelin::interfaces::accesscontrol::IAccessControlWithDelay;
```
...
```cairo
use openzeppelin::interfaces::accesscontrol_default_admin_rules::IAccessControlDefaultAdminRules;
```
