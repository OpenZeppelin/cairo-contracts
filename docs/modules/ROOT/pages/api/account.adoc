...
NOTE: Every function involving signature verification, verifies with the account's current public key, using the Secp256k1 curve.
...
==== `[.contract-item-name]#++__validate_deploy__++#++(self: @ContractState, class_hash: felt252, contract_address_salt: felt252, public_key: Secp256k1Point) → felt252++` [.item-kind]#external#
...
==== `[.contract-item-name]#++get_public_key++#++(self: @ContractState)++ → Secp256k1Point` [.item-kind]#external#

Returns the current public key of the account.

[.contract-item]
[[EthAccountComponent-set_public_key]]
==== `[.contract-item-name]#++set_public_key++#++(ref self: ContractState, new_public_key: Secp256k1Point)++` [.item-kind]#external#
...
==== `[.contract-item-name]#++getPublicKey++#++(self: @ContractState)++ → Secp256k1Point` [.item-kind]#external#

See xref:EthAccountComponent-get_public_key[get_public_key].

[.contract-item]
[[EthAccountComponent-setPublicKey]]
==== `[.contract-item-name]#++setPublicKey++#++(ref self: ContractState, newPublicKey: Secp256k1Point)++` [.item-kind]#external#
...
==== `[.contract-item-name]#++initializer++#++(ref self: ComponentState, public_key: Secp256k1Point)++` [.item-kind]#internal#
...
==== `[.contract-item-name]#++_set_public_key++#++(ref self: ComponentState, new_public_key: Secp256k1Point)++` [.item-kind]#internal#
...
==== `[.contract-item-name]#++constructor++#++(ref self: ContractState, public_key: Secp256k1Point)++` [.item-kind]#constructor#
