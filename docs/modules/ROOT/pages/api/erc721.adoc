...
--
.InternalImpl
* xref:#ERC721Component-initializer[`++initializer(self, name, symbol)++`]
...
* xref:#ERC721Component-_set_token_uri[`++_set_token_uri(self, token_id, token_uri)++`]
--
...
[.contract-item]
[[ERC721Component-_set_token_uri]]
