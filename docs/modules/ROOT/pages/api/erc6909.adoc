...
* xref:#ERC6909ContentURIComponent-_set_contract_uri[`++_set_contract_uri(self, contract_uri)++`]
* xref:#ERC6909ContentURIComponent-_set_token_uri[`++_set_token_uri(self, id, token_uri)++`]
--
...
[.contract-item]
[[ERC6909ContentURIComponent-_set_contract_uri]]
==== `[.contract-item-name]#++_set_contract_uri++#++(ref self: ContractState, contract_uri: ByteArray)++` [.item-kind]#internal#
...
[.contract-item]
[[ERC6909ContentURIComponent-_set_token_uri]]
==== `[.contract-item-name]#++_set_token_uri++#++(ref self: ContractState, id: u256, token_uri: ByteArray)++` [.item-kind]#internal#
