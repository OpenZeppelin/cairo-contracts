...
[.hljs-theme-dark]
```cairo
use openzeppelin::interfaces::erc1155::IERC1155;
```
...
[.hljs-theme-dark]
```cairo
use openzeppelin::interfaces::erc1155::IERC1155MetadataURI;
```
...
[.hljs-theme-dark]
```cairo
use openzeppelin::interfaces::erc1155::IERC1155Receiver;
```
