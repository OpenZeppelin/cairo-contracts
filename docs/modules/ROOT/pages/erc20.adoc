...
WARNING: Prior to {version}, ERC20 iterations store and read `decimals` from storage; however, this library's implementation returns a static `18`.
...
* The standard function selectors are written in snake_case as opposed to camelCase in Solidity.
