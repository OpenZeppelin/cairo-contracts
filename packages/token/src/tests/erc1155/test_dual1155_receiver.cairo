...
fn setup_snake() -> (DualCaseERC1155Receiver, IERC1155ReceiverDispatcher) {
    let calldata = array![];
    let target = test_utils::deploy(SnakeERC1155ReceiverMock::TEST_CLASS_HASH, calldata);
    (
...
fn setup_camel() -> (DualCaseERC1155Receiver, IERC1155ReceiverCamelDispatcher) {
    let calldata = array![];
    let target = test_utils::deploy(CamelERC1155ReceiverMock::TEST_CLASS_HASH, calldata);
    (
        DualCaseERC1155Receiver { contract_address: target },
...
fn setup_erc1155_receiver_panic() -> (DualCaseERC1155Receiver, DualCaseERC1155Receiver) {
    let snake_target = test_utils::deploy(SnakeERC1155ReceiverPanicMock::TEST_CLASS_HASH, array![]);
    let camel_target = test_utils::deploy(CamelERC1155ReceiverPanicMock::TEST_CLASS_HASH, array![]);
    (
